...
class TimeVulnerability(StageTest):
    ...
    def check(self, reply, attach):
        ...
        if not self.connected:
            return CheckResult.false("You didn't connect to the server")
        ...
        if login != real_login:
            return CheckResult.false('The login you printed is not correct')
        elif password != real_password:
            return CheckResult.false('The password you printed is not correct')
        ...
        for i in self.message:
            ...
            if find_first_letter is True:
                if log != real_login:
                    return CheckResult.false('You should find a correct login and then use only it')
...
if __name__ == '__main__':
    test = TimeVulnerability('hacking_my_part.hack')
    test.run_tests()
    test.stop_server()
